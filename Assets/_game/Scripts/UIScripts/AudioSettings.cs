...
namespace _game.Scripts
{
    public class AudioSettings : MonoBehaviour
    {
        ...
        public void MasterVolumeLevel(float _newMasterVolume) { _masterVolume = _newMasterVolume; }
        public void MusicVolumeLevel(float _newMusicVolume) { _musicVolume = _newMusicVolume; }

        public void SFXVolumeLevel(float _newSFXVolume) { _sfxVolume = _newSFXVolume; }
